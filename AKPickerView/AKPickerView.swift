...
private class AKCollectionViewLayout: UICollectionViewFlowLayout {
	...
	private override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
...
private class AKPickerViewDelegateIntercepter: NSObject, UICollectionViewDelegate {
	...
	private override func forwardingTarget(for aSelector: Selector) -> AnyObject? {
...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	*/
	private func offsetForItem(_ item: Int) -> CGFloat {
	...
	*/
	...
	// MARK: AKCollectionViewLayoutDelegate
	private func pickerViewStyleForCollectionViewLayout(_ layout: AKCollectionViewLayout) -> AKPickerViewStyle {
