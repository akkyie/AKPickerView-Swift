...
@objc public protocol AKPickerViewDataSource {
	...
	@objc optional func titleForItem(inPickerView pickerView: AKPickerView, at index: Int) -> String
	@objc optional func imageForItem(inPickerView pickerView: AKPickerView, at index: Int) -> UIImage?
}
...
@objc public protocol AKPickerViewDelegate: UIScrollViewDelegate {
	@objc optional func didSelectItem(inPickerView pickerView: AKPickerView, at index: Int)
...
open class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	*/
	...
	open override func layoutSubviews() {
		...
		if self.dataSource != nil && self.dataSource!.numberOfItems(inPickerView: self) > 0 {
	...
	*/
	fileprivate func selectItem(_ item: Int, animated: Bool, notifySelection: Bool) {
		...
		if notifySelection {
            self.delegate?.didSelectItem?(inPickerView: self, at: item)
		}
	}
	...
	*/
	fileprivate func didEndScrolling() {
		...
		case .wheel:
			if let numberOfItems = self.dataSource?.numberOfItems(inPickerView: self) {
	...
	open func numberOfSections(in collectionView: UICollectionView) -> Int {
		return self.dataSource != nil && self.dataSource!.numberOfItems(inPickerView: self) > 0 ? 1 : 0
	}

	open func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
		return self.dataSource != nil ? self.dataSource!.numberOfItems(inPickerView: self) : 0
	}
	...
	open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		if let title = self.dataSource?.titleForItem?(inPickerView: self, at: indexPath.item) {
		...
		} else if let image = self.dataSource?.imageForItem?(inPickerView: self, at: indexPath.item) {
